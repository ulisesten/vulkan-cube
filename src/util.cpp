...
bool memory_type_from_properties(struct Info &info, uint32_t typeBits, VkFlags requirements_mask, uint32_t *typeIndex) {
...
void set_image_layout(struct Info &info, VkImage image, VkImageAspectFlags aspectMask, VkImageLayout old_image_layout,
